...
**/
- (instancetype)initWithAsyncSocket:(AsyncSocket *)newSocket forServer:(HTTPServer *)myServer
{
	if((self = [super init]))
	{
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				// Write range header
				NSData *rangeHeader = ranges_headers[0];
...
- (void)doneWithBody
{
	// Override me to dealloc buffers, close file handles, etc.
}
