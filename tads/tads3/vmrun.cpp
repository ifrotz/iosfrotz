    ...
    err_try
    {
        ...
        exec_instruction:
            ...
            if (do_autosave) {
                ...
                // vm_rcdesc rc(vmg_ "saveGame", CVmBifTADS::bif_table, 15, G_stk->get(0), argc);
                CVmNetFile *netfile = CVmNetFile::open(AUTOSAVE_FILE, 0, 
                                                       NETF_WRITE | NETF_CREATE | NETF_TRUNC,
