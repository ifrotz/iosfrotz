...
-(void)dbUploadSaveGameFile:(NSString*)saveGameSubPath { // includes game subfolder, e.g. 905.z5.d/foo.sav
    ...
    [[client.filesRoutes uploadUrl:dbSGPath mode:mode autorename:false clientModified:nil mute:false propertyGroups:nil strictConflict:false inputUrl:localSavePath]
