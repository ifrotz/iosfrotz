...
- (void)showReleaseNotes {
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath: m_relNotesPath]) {
        ...
        "<p><ul>\n"
        "<li><b>Now plays games in TADS format (v2/v3).</b></li>\n"
        "<li><b>Improved performance and 64-bit support.</b></li>\n"
        "<li><b>Split-screen multitasking support on iPads.</b></li>\n"
        "<li><b>Fix crash when task-switching back to Frotz in iOS 9.x.</b></li>\n"
        "<li><b>Various other bug fixes.</b></li>\n"
        "</ul>\n"
        "<p>If you enjoy Frotz, please rate it in the App Store.  Or write  a review! Thanks!</p>"
        "<p><small><i>Craig Smith, September 2016</i><br>\n"
        "<hr>\n"
