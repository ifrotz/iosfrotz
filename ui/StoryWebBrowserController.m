...
-(void)loadView {
    ...
    NSURL *myURL = [NSURL URLWithString:
                    [NSString stringWithFormat: @"https://%@/search?sortby=ttl&newSortBy.x=9&newSortBy.y=9&searchfor=system%%3Ainform+rating%%3A3-+%%23ratings%%3A2-+language%%3Aenglish&browse=1", kIFDBHost]];
