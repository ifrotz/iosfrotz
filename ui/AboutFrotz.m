...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString *content = [NSString stringWithFormat: @
                         ...
                         "Frotz 1.8 introduced TADS game support, based on TADS 2 and TADS 3 game engines by <b>Michael Roberts</b> under the TADS Freeware License, and using the TADS Glk I/O binding from Gargoyle by <b>Tor Andersson</b> and <b>Ben Cressey</b> (GPLv2).\n"
                         "Game splash screens include artwork by <b>Andrew Bossi</b>, <b>Trey Radcliff</b>, and <b>Mike Green</b>, distributed under Creative Commons with attribution.  Special thanks to <b>Michael Roberts</b> for maintaining the IFDB web resources, and to <b>Graham Nelson</b>, <b>Andrew Plotkin</b>, <b>Emily Short</b>, <b>Adam Cadre</b>, and the other IF authors whose works are distributed with Frotz for iOS or made freely available to adventurers everywhere on IFDB."
                         "</p>\n"
                         "<hr>\n"
