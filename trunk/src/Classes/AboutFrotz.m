...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString *content = [NSString stringWithFormat: @
                         ...
                         @"<b>Frotz</b> comes with a collection of bundled stories/games, and works with most stories written in the Z-Machine format. "
                         ...
                         "Interactive Fiction Database (IFDB). When you find one that interests you, select the link for the Z-machine file (extensions .z3, .z4, .z5, or .zblorb) "
