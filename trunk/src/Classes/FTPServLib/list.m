...
// ----------------------------------------------------------------------------------------------------------
NSString* createList(NSString* directoryPath, BOOL shortForm)
// ----------------------------------------------------------------------------------------------------------
{
	...
	while ((filePath = [dirEnum nextObject])) {
		...
		if ( ![ firstChar isEqualToString:@"."]
            && !isHiddenFile(filePath))			// dont show hidden files
		{
			fullFilePath = [directoryPath stringByAppendingPathComponent:filePath];
			if (shortForm) {
                formattedString = [ NSString stringWithFormat: @"%@", filePath];
            } else {
